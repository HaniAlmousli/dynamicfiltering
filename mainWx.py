...
model = MLPWx(x,y,conf, n_in=featureSize, outClass=10)           
...
#             pickle.dump(sess.run(model.layers[0].params[0]),open('/home/hani/ModelOut/dynamicfiltering/firstTrial/regular.pkl','wb'))
          ...
          # save_path = saver.save(sess, "/home/hani/ModelOut/dynamicfiltering/mnistwx3.ckpt")
...
#           testAccuracy = 100*(testAccuracy/testSize)
#           save_path = saver.save(sess, "/home/hani/ModelOut/dynamicfiltering/mnistwx3.ckpt")
#           pickle.dump([conf,batch_LL,valAccuracy,testAccuracy],open('/home/hani/ModelOut/dynamicfiltering/mnistwx4.pkl','wb'))
